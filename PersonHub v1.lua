...
local Tab = Window:NewTab("Murder Mistery 2")

local Selection = Tab:NewSelection("ESP - видеть сквозь стены")
...
local Selection = Tab:NewSelection("Управление скоростью и гравитацией")  

Section:NewSlider("WalkSpeed", "WalkSpeed", 500, 0, function(s)
	game.Players.LocalPlayer.Character.Humanoid.WalkSpped = s 
end)  
...
local Tab = Window:NewTab("Универсально")

local Selection = Tab:NewSelection("Универсальное esp, подходит под любые игры")
